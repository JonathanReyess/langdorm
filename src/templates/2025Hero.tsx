  ...
  <Background color="bg-gray-100">
    ...
    <Section yPadding="pt-0 pb-20"> {/* Adjust the top padding here */}
      ...
      <div className="text-center mb-8"> {/* Center-aligns text and adds margin-bottom */}
        {/* Large text */}
        <h1 className="text-4xl mb-4 text-gray-800">2024-2025</h1>
      </div>
      {/* Rendering the image */}
      <div className="flex justify-center items-center">
  <div className="w-custom-1200 h-96 relative"> {/* Set the desired width and height */}
    <img
      src="/assets/coming_soon.png" // Image source
      alt="LangDorm Logo" // Alternative text for accessibility
      className="absolute inset-0 w-full h-full object-contain" // Fit the image to cover the container
    />
  </div>
</div>
