...
const AboutPage: NextPage = () => {
  ...
  const classesData = {
    '2023': [
      ...
      { id: 4, name: 'Himani Bhat', major: 'Major: ', hometown: 'Hometown: ', languages: 'Languages: ', imageUrl: '/people/himani_bhat.jpg' },
    ...
    '2024': [
      ...
      { id: 5, name: 'Islina Shan', major: 'Major: ', hometown: 'Hometown: ', languages: 'Languages: ', imageUrl: '/people/islina_shan.jpg' },
    ...
    '2025': [
      ...
      { id: 3, name: 'Elaine Guo', major: 'Major: ', hometown: 'Hometown: ', languages: 'Languages: ', imageUrl: '/people/elaine_guo.jpg' },
      ...
      { id: 8, name: 'Kulsoom Rizavi', major: 'Major: ', hometown: 'Hometown: ', languages: 'Languages: ', imageUrl: '/people/kulsoom_rizavi.jpg' },
      { id: 9, name: 'Lyndrinn Yao', major: 'Major: Computer Science', hometown: 'Hometown: ', languages: 'Languages: ', imageUrl: '/people/lyndrinn_yao.jpg' },
    ...
    '2026': [
      ...
      { id: 2, name: 'Anna Zhang', major: 'Major: Computer Science', hometown: 'Hometown: ', languages: 'Languages: ', imageUrl: '/people/person_placeholder.png' },
      { id: 3, name: 'Erica Shen', major: 'Major: ', hometown: 'Hometown: ', languages: 'Languages: ', imageUrl: '/people/person_placeholder.png'},
      { id: 4, name: 'Flora Ye', major: 'Major:', hometown: 'Hometown: ', languages: 'Languages: ', imageUrl: '/people/person_placeholder.png' },
      { id: 5, name: 'Irene Biju', major: 'Major: ', hometown: 'Hometown: ', languages: 'Languages: ', imageUrl: '/people/person_placeholder.png'},
      { id: 6, name: 'Jadelyn Ding', major: 'Major: ', hometown: 'Hometown: ', languages: 'Languages: ', imageUrl: '/people/person_placeholder.png' },
      ...
      { id: 9, name: 'Katherine Chen', major: 'Major: ', hometown: 'Hometown: ', languages: 'Languages: ', imageUrl: '/people/person_placeholder.png' },
      { id: 10, name: 'Montana Lee', major: 'Major: ', hometown: 'Hometown: ', languages: 'Languages: ', imageUrl: '/people/person_placeholder.png' },
