...
const MemberHero = () => (
  <>
    {/* Rendering a Section component with customized vertical padding */}
    <Section yPadding="pt-0 pb-20">
      ...
      <div className="mb-8 text-center">
        ...
        {/* Large text */}
        <h1 className="mb-4 text-4xl text-gray-800">2022-2023</h1>
      </div>
      {/* Rendering the image */}
      <div className="flex items-center justify-center">
        <div className="relative h-96 w-custom-1200" style={{ zIndex: 0 }}>
          {/* Full width and fixed height */}
          <img
            src="/assets/ld_2022.png" // Image source
            alt="LangDorm Logo" // Alternative text for accessibility
            className="absolute inset-0 h-full w-full object-contain" // Fit the image to contain within the container
          />
        </div>
      </div>
    </Section>
