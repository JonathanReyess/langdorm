  ...
  const classesData = {
    '2023': [
      ...
      },
      {
        id: 2,
        name: 'Cassie Lu',
        major: 'Major: Computer Science, Economics',
        hometown: 'Hometown: Taiwan',
        languages: 'Languages: Chinese, Taiwanese',
        imageUrl: '/people/cassie_lu.png',
      },
      {
        id: 3,
        name: 'Feng Cong',
        major: 'Major: Math, CS',
        hometown: 'Hometown: Singapore',
        languages: 'Languages: Chinese',
        imageUrl: '/people/feng_cong.jpg',
      },
      {
        id: 4,
        name: 'Himani Bhat',
        ...
        hometown: 'Hometown: ',
        languages: 'Languages: ',
        imageUrl: '/people/himani_bhat.jpg',
      },
      {
        id: 5,
        name: 'Ishaan Ghosh',
        ...
        hometown: 'Hometown: ',
        languages: 'Languages: ',
        imageUrl: '/people/ishaan_ghosh.jpg',
      },
      {
        id: 6,
        name: 'Jack Smoot',
        ...
        hometown: 'Hometown: ',
        languages: 'Languages: Spanish, Arabic',
        imageUrl: '/people/jack_smoot.jpg',
      },
      {
        id: 7,
        name: 'Jayesh Gupta',
        ...
        hometown: 'Hometown: ',
        languages: 'Languages: ',
        imageUrl: '/people/jayesh_gupta.jpeg',
      },
      {
        id: 8,
        name: 'Jen Wang',
        ...
        imageUrl: '/people/jen_wan.jpg',
      },
      {
        id: 9,
        name: 'Lindsay Hu',
        major: 'Major: Civil Engineering',
        hometown: 'Hometown: Hong Kong',
        languages: 'Languages: Mandarin',
        imageUrl: '/people/lindsay_hu.jpg',
      },
      {
        id: 10,
        name: 'Maryam Shahid',
      ...
      },
      {
        ...
        name: 'William Kim',
        major: 'Major: Mechanical Engineering',
        hometown: 'Hometown: Las Vegas, Nevada',
      ...
      },
      {
        id: 12,
        name: 'Yihan Shi',
        major: 'Major: Neuroscience, Statistics',
        hometown: 'Hometown: Shanghai, China',
        languages: 'Languages: Mandarin',
        imageUrl: '/people/yihan_shi.jpeg',
      },
    ],
    '2024': [
      {
        id: 1,
        name: 'Ace Abdulrahman',
      ...
      },
      {
        ...
        name: 'Cynthia France',
        major: 'Major: ECE + CS',
        hometown: 'Hometown: Omaha, NE',
        languages: 'Languages: Mandarin, Spanish',
        imageUrl: '/people/cynthia_france.jpg',
      },
      {
        id: 4,
        name: 'Dominic Martinez',
        major: 'Major: Computer Science',
        hometown: 'Hometown: Florida',
        languages: 'Languages: Japanese',
        imageUrl: '/people/dominic_martinez.jpg',
      },
      {
        id: 5,
        name: 'Islina Shan',
        ...
        hometown: 'Hometown: ',
        languages: 'Languages: ',
        imageUrl: '/people/islina_shan.jpg',
      },
      {
        id: 6,
        name: 'Lia Lemieux',
        major: 'Major: Public Policy',
        hometown: 'Hometown: Minnesota',
        languages: 'Languages: Spanish',
      ...
      {
        id: 8,
        name: 'Muaz Bin Kashif',
        major: 'Major: Computer Science',
        hometown: 'Hometown: Pakistan',
        languages: 'Languages: Hindi-Urdu, Punjabi',
        imageUrl: '/people/muaz_kashif.jpg',
      },
      {
        id: 9,
        name: 'Zach Pracher',
    ...
    '2025': [
      ...
      },
      {
        ...
        hometown: 'Hometown: ',
        languages: 'Languages: ',
        imageUrl: '/people/elaine_guo.jpg',
      },
      {
        id: 4,
        name: 'Emily Sun',
      ...
      },
      {
        id: 6,
        name: 'Jaeden Toy',
        major: 'Major: Computer Science, Russian ',
        hometown: 'Hometown: ',
        languages: 'Languages: ',
        imageUrl: '/people/jaeden_toy.jpg',
      },
      {
        id: 7,
        name: 'Kaitlyn Yan',
    ...
    <div key={member.id} className="flex w-1/4 flex-col items-center p-4">
      <div className="relative h-60 w-60">
        ...
        <img
          src={member.imageUrl}
          alt={member.name}
          className={`absolute inset-0 h-full w-full border-4 object-cover`} // Use object-cover to fit images
        />
      </div>
