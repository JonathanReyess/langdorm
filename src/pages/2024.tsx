...
const AboutPage: NextPage = () => {
  ...
  const classesData = {
    ...
    '2025': [
      ...
      { id: 5, name: 'Kulsoom Rizavi', major: 'Major: Political Science, Computer Science', hometown: 'Hometown: ', languages: 'Languages: Hindi, Urdu, French', imageUrl: '/people/person_placeholder.png' },
      { id: 6, name: 'Lyndrinn Yao', major: 'Major: Computer Science, Statistics', hometown: 'Hometown: ', languages: 'Languages: Mandarin', imageUrl: '/people/person_placeholder.png' },
