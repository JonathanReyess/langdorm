    ...
    <Section>
      ...
      <CenteredFooter
        ...
        iconList={ // Icon list containing social media icons, each wrapped in a Link component
          <>
            {/* Example social media icons as SVG images, each wrapped in a Link component */}
            <Link href="https://www.facebook.com/langdorm/" aria-label="Facebook">
            ...
            <Link href="https://www.instagram.com/dukelangdorm/" aria-label="Instagram">
            ...
            {/* Add more social media icons similarly */}
          </>
        }
      >
